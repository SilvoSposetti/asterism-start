...
void Renderer::initializeRenderer() {
    std::cout << "ASDFVAJUHSFKJASHFGLKASF" << std::endl;
    initializeWindow();
    initializeVulkan();
    mainLoop();
    cleanup();
...
SwapChainSupportDetails Renderer::querySwapChainSupport(VkPhysicalDevice vkPhysicalDevice) {
...
bool Renderer::isDiscreteGPU(VkPhysicalDevice device) {
...
bool Renderer::isIntegratedGPU(VkPhysicalDevice device) {
    VkPhysicalDeviceProperties properties;
    vkGetPhysicalDeviceProperties(device, &properties);
